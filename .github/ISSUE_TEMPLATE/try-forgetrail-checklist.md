...
<!-- One or two sentences: new idea, existing PRD, or just exploring -->
...
- OS:
- Coding agent (Cursor / Claude Code / Codex / other):
- Chat app used for Genesis (if any):

## Anything else

<!-- Praise, confusion, or a doc line that misled you -->
