...
- [ ] [ForgeTrail naming pass](specs/partial/forgetrail-rename.md): landed in this repo and sibling consumers; remaining GitHub slug, anticonfab `.forgekit/` folder lock, first Wrangler ship + forgetrail.dev DNS
