...
An earlier draft explored a paid, cloud-hosted MCP product model. That plan is **not** the shipping model. Detailed strategy notes were removed from this public tree; private history may exist in the `forge-kit-original` archive repo if needed.
