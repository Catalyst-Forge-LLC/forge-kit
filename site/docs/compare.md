...
Most AI chats forget. ForgeTrail keeps **phase state**, **decisions**, and **gotchas** in the repo, and leaves a trail of lessons the next build follows via [propagate-to-forgetrail](https://github.com/Catalyst-Forge-LLC/forgetrail/blob/main/prompts/propagate-to-forgetrail.md).
