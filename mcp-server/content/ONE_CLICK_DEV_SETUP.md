...
Upstream reference scripts: `mcp-server/content/scripts/` (`forgekit-dev-launcher.mjs`, `setup-pocketbase.mjs`, `test-pocketbase.mjs`, `setup-ollama.mjs`, `test-ollama.mjs`, `forgekit-env.mjs`). Isolated checks: **`SYSTEM_HEALTH_CHECKS.md`**.
